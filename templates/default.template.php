...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        You can get free {{COINNAME}} every thirty minutes.
  </div>
</div>
...
<div class="panel panel-default">
    ...
    <?php 
        switch ($this->status())
        {
            case BYND_STATUS_FAUCET_INCOMPLETE:
    ?>
    <div class="panel panel-default">
        <div class="panel-heading">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            This faucet is dry! Please donate some Beyondcoins to keep it running.
        </div>
    </div>
    <?php
	break;
            case BYND_STATUS_RPC_CONNECTION_FAILED:
            case BYND_STATUS_MYSQL_CONNECTION_FAILED:
	?>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Status</h3>
    ...
    <?php
	break;
            case BYND_STATUS_PAYOUT_ACCEPTED:
	?>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Status</h3>
        ...
        <div class="panel-body">
            Success! You have received {{PAYOUT_AMOUNT}} {{COINNAME}}!
        </div>
    </div>
    <?php
    break;
            case BYND_STATUS_PAYOUT_AND_PROMO_ACCEPTED:
	?>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Status</h3>
        ...
        <div class="panel-body">
            Success! You have received {{PAYOUT_AMOUNT}} {{COINNAME}}!<br/>
            Additionally, you received a bonus of {{PROMO_PAYOUT_AMOUNT}} {{COINNAME}}!
        </div>
    </div>
	<?php
	break;
            case BYND_STATUS_PAYOUT_ERROR:
    ?>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Status</h3>
    ...
    <?php
	break;
            case BYND_STATUS_PAYOUT_DENIED:
	?>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Status</h3>
        ...
        <div class="panel-body">
            You have already claimed from this faucet within the last thirty minutes. Please try again later.
        </div>
    </div>
    <?php
    break;
            case BYND_STATUS_PROXY_DETECTED:
	?>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Status</h3>
        ...
        <div class="panel-body">
            Sorry, proxies are not allowed.
        </div>
    </div>
    <?php
	break;
            case BYND_STATUS_CAPTCHA_INCORRECT:
            case BYND_STATUS_INVALID_DOGE_ADDRESS:
            case BYND_STATUS_OPERATIONAL:
	?>
	...
	<?php
        if ($this->status() == BYND_STATUS_INVALID_DOGE_ADDRESS)
        {
    ?>
    ...
    <?php
	   ...
	   elseif ($this->status() == BYND_STATUS_CAPTCHA_INCORRECT)
	{
	?>
    <div class="panel panel-default margintop">
        <div class="panel-heading">
