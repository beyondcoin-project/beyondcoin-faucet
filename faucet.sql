...
INSERT INTO `bynd_promo_codes` (`id`, `code`, `minimum_payout`, `maximum_payout`, `uses`) VALUES
(11, 'double', 1, 1, -1);

CREATE TABLE `bynd_staged_payments` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `payout_address` varchar(34) NOT NULL DEFAULT '',
